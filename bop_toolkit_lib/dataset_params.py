    ...
    p.update(
        {
            ...
            "img_dir_coco_tpath": join(
                datasets_path, "coco", f"{dataset_name}", f"{split}"
            ),
            ...
            "vis_pred_path": join(
                ...
                "predictions",
                f"{split}",
                "vis/{scene_id:06d}_{im_id:06d}.png",
            ),
            ...
            "template_info_path": join(base_path, "templates", "template_info.json"),
